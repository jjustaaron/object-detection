...
public class Client extends javax.swing.JFrame {
    ...
    private void chonanhActionPerformed(java.awt.event.ActionEvent evt) {
        try {
    ...
    private void chonanh1ActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            JFileChooser fileChooser = new JFileChooser();
            FileNameExtensionFilter filter = new FileNameExtensionFilter("Hình ảnh", "jpg", "jpeg", "png", "gif");
            fileChooser.setFileFilter(filter);
    ...
    private void xacnhan1ActionPerformed(java.awt.event.ActionEvent evt) {
        connectToServer();
        try (PrintWriter out = new PrintWriter(socket.getOutputStream(), true);
             BufferedReader in = new BufferedReader(new InputStreamReader(socket.getInputStream()))) {
            // Gửi đường dẫn ảnh đến server
            ...
            // Nhận và in kết quả từ server
            String line;
            if ((line = in.readLine()) != null && line.equals("end")) {

                System.out.println(line);
                JOptionPane.showMessageDialog(this, "Nhận diện thành công");
                // Hiển thị ảnh trên JLabel
                String imagePath = "D:\\Java projects\\object-detection\\image_with_objects.jpg";
